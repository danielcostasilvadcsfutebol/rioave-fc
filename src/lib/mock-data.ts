...
export const MOCK_COMPETICAO_LIGA = { id: 'comp-liga', nome: 'Liga Portugal', tipo: 'liga' as const, pais: 'Portugal' };
...
const DADOS: Record<string, { jogos: GameRaw[]; cap: number; divisao?: string }> = {
  ...
  '23/24': { cap: CAP_ATUAL, jogos: [
    ...
    { jornada:  9, adversario: 'Portimonense',     assistencia: 2593 },
  ...
  '22/23': { cap: CAP_ATUAL, jogos: [
    ...
    { jornada:  5, adversario: 'Portimonense',     assistencia: 1693 },
    { jornada:  6, adversario: 'Boavista',    assistencia: 2546 },
    { jornada:  7, adversario: 'Marítimo',    assistencia: 1492 },
    { jornada:  8, adversario: 'Paços de Ferreira',       assistencia: 2310 },
  ...
  '20/21': { cap: CAP_ATUAL, jogos: [
    ...
    { jornada:  6, adversario: 'Portimonense',     assistencia: 0, porta_fechada: true },
    ...
    { jornada: 12, adversario: 'BSAD',       assistencia: 0, porta_fechada: true },
    ...
    { jornada: 15, adversario: 'Paços de Ferreira',       assistencia: 0, porta_fechada: true },
    { jornada: 16, adversario: 'Sporting',    assistencia: 0, porta_fechada: true },
    { jornada: 17, adversario: 'Porto',       assistencia: 0, porta_fechada: true },
  ]},
  '19/20': { cap: CAP_ATUAL, jogos: [
    ...
    { jornada: 13, adversario: 'Paços de Ferreira',       assistencia: 0, porta_fechada: true },
    ...
    { jornada: 16, adversario: 'Portimonense',     assistencia: 0, porta_fechada: true },
  ...
  '18/19': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada:  2, adversario: 'Portimonense',     assistencia: 2539  },
  ...
  '17/18': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada:  2, adversario: 'Portimonense',     assistencia: 2541  },
    ...
    { jornada:  9, adversario: 'Paços de Ferreira', assistencia: 1781  },
    ...
    { jornada: 17, adversario: 'Braga',       assistencia: 7452  },
  ]},
  '16/17': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada: 12, adversario: 'Paços de Ferreira', assistencia: 2661  },
    ...
    { jornada: 16, adversario: 'Benfica',     assistencia: 8767  },
    { jornada: 17, adversario: 'BSAD',        assistencia: 4584  },
  ]},
  '15/16': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada: 12, adversario: 'Paços de Ferreira',  assistencia: 2290  },
    { jornada: 13, adversario: 'Estoril',      assistencia: 2170  },
    { jornada: 14, adversario: 'Marítimo',     assistencia: 2403  },
    { jornada: 15, adversario: 'Vitória',      assistencia: 3107  },
    { jornada: 16, adversario: 'Benfica',      assistencia: 9023  },
    { jornada: 17, adversario: 'Porto',        assistencia: 3201  },
  ]},
  '14/15': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada: 13, adversario: 'Benfica',      assistencia: 9692  },
    { jornada: 14, adversario: 'Porto',        assistencia: 5534  },
    { jornada: 15, adversario: 'Vitória',      assistencia: 2393  },
    { jornada: 16, adversario: 'Paços de Ferreira',  assistencia: 3721  },
    { jornada: 17, adversario: 'Sporting',     assistencia: 3747  },
  ]},
  '13/14': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada: 15, adversario: 'Paços de Ferreira',  assistencia: 1630  },
  ]},
  '12/13': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada:  6, adversario: 'Paços de Ferreira',  assistencia: 1551  },
  ...
  '11/12': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada:  7, adversario: 'Paços de Ferreira',  assistencia: 1602  },
  ...
  '10/11': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada:  6, adversario: 'Paços de Ferreira',  assistencia: 1972  },
    ...
    { jornada: 10, adversario: 'Portimonense',      assistencia: 1339  },
  ...
  '09/10': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada: 10, adversario: 'Paços de Ferreira',  assistencia: 1905  },
  ...
  '08/09': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada:  3, adversario: 'Paços de Ferreira',  assistencia: 1601  },
...
function epocaToYear(ep: string) {
  const y = parseInt(ep.split('/')[0]);
  return y < 50 ? y + 2000 : y + 1900;
}

export function getJogosByEpoca(epoca: string): JogoComRelacoes[] {
  const d = DADOS[epoca];
  if (!d) return [];
  const epocaObj = { id: `ep-${epoca.replace('/','-')}`, nome: epoca, ano_inicio: epocaToYear(epoca), ano_fim: epocaToYear(epoca)+1, ativa: epoca==='25/26', divisao: d.divisao ?? 'Liga Portugal' };
  return d.jogos.map((j, i) => {
    const cap = j.cap ?? d.cap;
    const estadio = j.estadio_alternativo ? MOCK_ESTADIO_PACOS : MOCK_ESTADIO_ARCOS;
    return {
      id: `${epoca}-${i+1}`, jornada: j.jornada, adversario: j.adversario,
      assistencia: j.assistencia, capacidade_jogo: cap,
      ...
      data_jogo: null, hora_jogo: null, golos_ra: null, golos_adversario: null,
      publicado: true, publicado_em: null,
      epoca_id: epocaObj.id, competicao_id: MOCK_COMPETICAO_LIGA.id, estadio_id: estadio.id,
      epoca: epocaObj, competicao: MOCK_COMPETICAO_LIGA, estadio,
    };
  });
}
...
export const MOCK_RESUMO_EPOCAS: ResumoEpoca[] = EPOCAS_ORDENADAS.map(epoca => {
  ...
  return {
    epoca, ano_inicio: epocaToYear(epoca), ativa: epoca === '25/26',
...
export function calcularKpis(jogos: JogoComRelacoes[]) {
  ...
  return { total, media, maximo, minimo, totalJogos: jogos.length,
...
export interface EstatAdversario {
  adversario: string; visitas: number; media: number;
  maximo: number; total: number; epocas: number;
}
