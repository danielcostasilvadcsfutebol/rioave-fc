...
const DADOS: Record<string, { jogos: GameRaw[]; cap: number; divisao?: string }> = {
  '2025/26': { cap: CAP_ATUAL, jogos: [
    { jornada: 1,  adversario: 'Nacional',    assistencia: 2452 },
    { jornada: 2,  adversario: 'S.C. Braga',  assistencia: 3250 },
    { jornada: 3,  adversario: 'F.C. Porto',  assistencia: 4624 },
    ...
    { jornada: 7,  adversario: 'Vitória SC',   assistencia: 2521 },
    { jornada: 8,  adversario: 'Casa Pia',     assistencia: 2067 },
    { jornada: 9,  adversario: 'S.L. Benfica', assistencia: 4435 },
    ...
    { jornada: 16, adversario: 'Gil Vicente',  assistencia: 2801 },
  ]},
  '2024/25': { cap: CAP_ATUAL, jogos: [
    ...
    { jornada: 7,  adversario: 'Vitória SC',   assistencia: 2897 },
    { jornada: 8,  adversario: 'Nacional',     assistencia: 2729 },
    { jornada: 9,  adversario: 'Sporting CP',  assistencia: 4756 },
    { jornada: 10, adversario: 'F.C. Porto',   assistencia: 4100 },
    { jornada: 11, adversario: 'AFS',          assistencia: 2206 },
    { jornada: 12, adversario: 'S.C. Braga',   assistencia: 3434 },
    { jornada: 13, adversario: 'S.L. Benfica', assistencia: 4753 },
    ...
    { jornada: 17, adversario: 'Gil Vicente',  assistencia: 909,  estadio_alternativo: true, cap: CAP_PACOS },
  ]},
  '2023/24': { cap: CAP_ATUAL, jogos: [
    { jornada: 1,  adversario: 'Chaves',       assistencia: 3044 },
    { jornada: 2,  adversario: 'F.C. Porto',   assistencia: 4811 },
    ...
    { jornada: 12, adversario: 'Sporting CP',  assistencia: 4406 },
    { jornada: 13, adversario: 'S.C. Braga',   assistencia: 2753 },
    { jornada: 14, adversario: 'Gil Vicente',  assistencia: 3085 },
    { jornada: 15, adversario: 'Arouca',       assistencia: 3225 },
    { jornada: 16, adversario: 'Vitória SC',   assistencia: 3624 },
    { jornada: 17, adversario: 'S.L. Benfica', assistencia: 4809 },
  ]},
  '2022/23': { cap: CAP_ATUAL, jogos: [
    { jornada: 1,  adversario: 'Vizela',       assistencia: 3038 },
    { jornada: 2,  adversario: 'F.C. Porto',   assistencia: 3980 },
    { jornada: 3,  adversario: 'S.C. Braga',   assistencia: 3071 },
    ...
    { jornada: 9,  adversario: 'Sporting CP',  assistencia: 4125 },
    { jornada: 10, adversario: 'Estoril',      assistencia: 2654 },
    { jornada: 11, adversario: 'Chaves',       assistencia: 3244 },
    { jornada: 12, adversario: 'Gil Vicente',  assistencia: 3036 },
    { jornada: 13, adversario: 'S.L. Benfica', assistencia: 4134 },
    { jornada: 14, adversario: 'Casa Pia',     assistencia: 2752 },
    { jornada: 15, adversario: 'Arouca',       assistencia: 2298 },
    { jornada: 16, adversario: 'Vitória SC',   assistencia: 4001 },
    { jornada: 17, adversario: 'Famalicão',    assistencia: 3037 },
  ]},
  '2021/22': { cap: CAP_ATUAL, divisao: 'Liga SABSEG (2ª Divisão)', jogos: [
    ...
    { jornada: 5,  adversario: 'Académico FC', assistencia: 720 },
    ...
    { jornada: 12, adversario: 'FC Porto B',   assistencia: 1729 },
  ...
  '2020/21': { cap: CAP_ATUAL, jogos: [
    { jornada: 1,  adversario: 'Vitória SC',   assistencia: 0, porta_fechada: true },
    { jornada: 2,  adversario: 'S.L. Benfica', assistencia: 0, porta_fechada: true },
    ...
    { jornada: 14, adversario: 'S.C. Braga',   assistencia: 0, porta_fechada: true },
    { jornada: 15, adversario: 'Paços',        assistencia: 0, porta_fechada: true },
    { jornada: 16, adversario: 'Sporting CP',  assistencia: 0, porta_fechada: true },
    { jornada: 17, adversario: 'F.C. Porto',   assistencia: 0, porta_fechada: true },
  ]},
  '2019/20': { cap: CAP_ATUAL, jogos: [
    { jornada: 1,  adversario: 'Vitória SC',   assistencia: 2713 },
    { jornada: 2,  adversario: 'CD Aves',      assistencia: 2485 },
    { jornada: 3,  adversario: 'Tondela',      assistencia: 2103 },
    { jornada: 4,  adversario: 'F.C. Porto',   assistencia: 4411 },
    { jornada: 5,  adversario: 'Moreirense',   assistencia: 1387 },
    { jornada: 6,  adversario: 'Setúbal',      assistencia: 1740 },
    ...
    { jornada: 11, adversario: 'Sporting CP',  assistencia: 4434 },
    { jornada: 12, adversario: 'B SAD',        assistencia: 2289 },
    { jornada: 13, adversario: 'Paços',        assistencia: 0, porta_fechada: true },
    { jornada: 14, adversario: 'S.L. Benfica', assistencia: 0, porta_fechada: true },
    { jornada: 15, adversario: 'S.C. Braga',   assistencia: 0, porta_fechada: true },
  ...
  '2018/19': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada: 6,  adversario: 'Sporting CP',  assistencia: 5927 },
    { jornada: 7,  adversario: 'B SAD',        assistencia: 2288 },
    ...
    { jornada: 13, adversario: 'S.C. Braga',   assistencia: 3306 },
    { jornada: 14, adversario: 'CD Aves',      assistencia: 4955 },
    { jornada: 15, adversario: 'Vitória SC',   assistencia: 5739 },
    { jornada: 16, adversario: 'F.C. Porto',   assistencia: 7532 },
    { jornada: 17, adversario: 'S.L. Benfica', assistencia: 8836 },
  ]},
  '2017/18': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'B SAD',        assistencia: 2539 },
    { jornada: 2,  adversario: 'Portim.',      assistencia: 2541 },
    { jornada: 3,  adversario: 'S.L. Benfica', assistencia: 8614 },
    { jornada: 4,  adversario: 'F.C. Porto',   assistencia: 8052 },
    { jornada: 5,  adversario: 'Setúbal',      assistencia: 2385 },
    { jornada: 6,  adversario: 'Sporting CP',  assistencia: 7158 },
    { jornada: 7,  adversario: 'Vitória SC',   assistencia: 3587 },
    ...
    { jornada: 13, adversario: 'Feirense',     assistencia: 2074 },
    { jornada: 14, adversario: 'Estoril',      assistencia: 2059 },
    { jornada: 15, adversario: 'Tondela',      assistencia: 3259 },
    { jornada: 16, adversario: 'Chaves',       assistencia: 4325 },
    { jornada: 17, adversario: 'S.C. Braga',   assistencia: 7452 },
  ]},
  '2016/17': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'F.C. Porto',   assistencia: 8357 },
    { jornada: 2,  adversario: 'Feirense',     assistencia: 2268 },
    { jornada: 3,  adversario: 'Sporting CP',  assistencia: 8315 },
    { jornada: 4,  adversario: 'Estoril',      assistencia: 3843 },
    { jornada: 5,  adversario: 'Vitória SC',   assistencia: 6166 },
    ...
    { jornada: 10, adversario: 'S.C. Braga',   assistencia: 1508 },
    { jornada: 11, adversario: 'Marítimo',     assistencia: 1981 },
    { jornada: 12, adversario: 'P. Ferreira',  assistencia: 2661 },
    { jornada: 13, adversario: 'Moreirense',   assistencia: 3098 },
    { jornada: 14, adversario: 'Setúbal',      assistencia: 2988 },
    { jornada: 15, adversario: 'Arouca',       assistencia: 2683 },
    { jornada: 16, adversario: 'S.L. Benfica', assistencia: 8767 },
    { jornada: 17, adversario: 'B SAD',        assistencia: 4584 },
  ]},
  '2015/16': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'S.C. Braga',   assistencia: 3825 },
    { jornada: 2,  adversario: 'Sporting CP',  assistencia: 6685 },
    ...
    { jornada: 10, adversario: 'B SAD',        assistencia: 2115 },
    { jornada: 11, adversario: 'Setúbal',      assistencia: 2355 },
    { jornada: 12, adversario: 'P. Ferreira',  assistencia: 2290 },
    { jornada: 13, adversario: 'Estoril',      assistencia: 2170 },
    { jornada: 14, adversario: 'Marítimo',     assistencia: 2403 },
    { jornada: 15, adversario: 'Vitória SC',   assistencia: 3107 },
    { jornada: 16, adversario: 'S.L. Benfica', assistencia: 9023 },
    { jornada: 17, adversario: 'F.C. Porto',   assistencia: 3201 },
  ]},
  '2014/15': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'Setúbal',      assistencia: 1959 },
    ...
    { jornada: 7,  adversario: 'B SAD',        assistencia: 1825 },
    ...
    { jornada: 11, adversario: 'S.C. Braga',   assistencia: 2375 },
    { jornada: 12, adversario: 'Nacional',     assistencia: 1850 },
    { jornada: 13, adversario: 'S.L. Benfica', assistencia: 9692 },
    { jornada: 14, adversario: 'F.C. Porto',   assistencia: 5543 },
    { jornada: 15, adversario: 'Vitória SC',   assistencia: 2393 },
    { jornada: 16, adversario: 'P. Ferreira',  assistencia: 3721 },
    { jornada: 17, adversario: 'Sporting CP',  assistencia: 3747 },
  ]},
  '2013/14': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'Setúbal',      assistencia: 1524 },
    { jornada: 2,  adversario: 'Vitória SC',   assistencia: 2452 },
    ...
    { jornada: 6,  adversario: 'S.L. Benfica', assistencia: 6023 },
    { jornada: 7,  adversario: 'F.C. Porto',   assistencia: 3896 },
    { jornada: 8,  adversario: 'Marítimo',     assistencia: 1773 },
    { jornada: 9,  adversario: 'B SAD',        assistencia: 1415 },
    { jornada: 10, adversario: 'Arouca',       assistencia: 1183 },
    { jornada: 11, adversario: 'Sporting CP',  assistencia: 4995 },
    { jornada: 12, adversario: 'Académica',    assistencia: 1615 },
    { jornada: 13, adversario: 'S.C. Braga',   assistencia: 1731 },
    { jornada: 14, adversario: 'Olhanense',    assistencia: 1579 },
    { jornada: 15, adversario: 'P. Ferreira',  assistencia: 1630 },
  ]},
  '2012/13': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'Marítimo',     assistencia: 1239 },
    { jornada: 2,  adversario: 'Académica',    assistencia: 1321 },
    { jornada: 3,  adversario: 'F.C. Porto',   assistencia: 3341 },
    { jornada: 4,  adversario: 'Nacional',     assistencia: 1477 },
    { jornada: 5,  adversario: 'S.L. Benfica', assistencia: 5028 },
    { jornada: 6,  adversario: 'P. Ferreira',  assistencia: 1551 },
    { jornada: 7,  adversario: 'Olhanense',    assistencia: 1385 },
    { jornada: 8,  adversario: 'Vitória SC',   assistencia: 1097 },
    { jornada: 9,  adversario: 'Sporting CP',  assistencia: 2356 },
    { jornada: 10, adversario: 'S.C. Braga',   assistencia: 4663 },
  ...
  '2011/12': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'S.C. Braga',   assistencia: 3322 },
    { jornada: 2,  adversario: 'Olhanense',    assistencia: 1829 },
    { jornada: 3,  adversario: 'Sporting CP',  assistencia: 4308 },
    ...
    { jornada: 12, adversario: 'Vitória SC',   assistencia: 2378 },
    { jornada: 13, adversario: 'Feirense',     assistencia: 2520 },
    { jornada: 14, adversario: 'S.L. Benfica', assistencia: 3706 },
    { jornada: 15, adversario: 'F.C. Porto',   assistencia: 5454 },
  ]},
  '2010/11': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'Nacional',     assistencia: 1654 },
    { jornada: 2,  adversario: 'F.C. Porto',   assistencia: 5064 },
    { jornada: 3,  adversario: 'Académica',    assistencia: 1627 },
    { jornada: 4,  adversario: 'Marítimo',     assistencia: 1184 },
    { jornada: 5,  adversario: 'S.C. Braga',   assistencia: 1817 },
  ...
  '2009/10': { cap: CAP_ANTIGA, jogos: [
    ...
    { jornada: 4,  adversario: 'S.C. Braga',   assistencia: 3696 },
    { jornada: 5,  adversario: 'Sporting CP',  assistencia: 3385 },
    { jornada: 6,  adversario: 'Belenenses',   assistencia: 1316 },
    { jornada: 7,  adversario: 'S.L. Benfica', assistencia: 7060 },
    ...
    { jornada: 13, adversario: 'F.C. Porto',   assistencia: 3402 },
    { jornada: 14, adversario: 'Marítimo',     assistencia: 1221 },
    { jornada: 15, adversario: 'Vitória SC',   assistencia: 3364 },
  ]},
  '2008/09': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'S.L. Benfica', assistencia: 10426 },
    { jornada: 2,  adversario: 'F.C. Porto',   assistencia: 2735 },
    { jornada: 3,  adversario: 'P. Ferreira',  assistencia: 1601 },
    { jornada: 4,  adversario: 'Sporting CP',  assistencia: 3549 },
    { jornada: 5,  adversario: 'Leixões',      assistencia: 2507 },
    { jornada: 6,  adversario: 'Naval',        assistencia: 3048 },
    { jornada: 7,  adversario: 'Vitória SC',   assistencia: 2898 },
    ...
    { jornada: 14, adversario: 'S.C. Braga',   assistencia: 4437 },
    { jornada: 15, adversario: 'Estrela',      assistencia: 7073 },
  ]},
  '2007/08': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'Gondomar',     assistencia: 729 },
    { jornada: 2,  adversario: 'Portim.',      assistencia: 729 },
  ...
  '2006/07': { cap: CAP_ANTIGA, jogos: [
    { jornada: 1,  adversario: 'Varzim',          assistencia: 2982 },
    { jornada: 2,  adversario: 'Olivais e Mosc.', assistencia: 1391 },
    ...
    { jornada: 6,  adversario: 'Vitória SC',      assistencia: 2017 },
    ...
    { jornada: 13, adversario: 'Portim.',         assistencia: 4822 },
    { jornada: 14, adversario: 'Gondomar',        assistencia: 5970 },
    { jornada: 15, adversario: 'Vizela',          assistencia: 855 },
  ]},
};

export const EPOCAS_ORDENADAS = Object.keys(DADOS).sort((a, b) =>
...
export function getJogosByEpoca(epoca: string): JogoComRelacoes[] {
  ...
  const epocaObj = {
    id: `ep-${epoca.replace('/', '-')}`,
    nome: epoca,
    ano_inicio: parseInt(epoca.split('/')[0]),
    ano_fim: parseInt(epoca.split('/')[0]) + 1,
    ativa: epoca === '2025/26',
    divisao: d.divisao ?? 'Liga Portugal Betclic',
  };
  return d.jogos.map((j, i) => {
    ...
    return {
      ...
      local: 'casa' as const,
      notas: j.porta_fechada
        ? 'À porta fechada (COVID-19)'
        : j.estadio_alternativo
        ? 'Estádio Capital do Móvel (Tempestade Martinho)'
        : null,
...
export const MOCK_RESUMO_EPOCAS: ResumoEpoca[] = EPOCAS_ORDENADAS.map(epoca => {
  ...
  return {
    epoca, ano_inicio: parseInt(epoca.split('/')[0]), ativa: epoca === '2025/26',
...
export const MOCK_JOGOS_2526 = getJogosByEpoca('2025/26');
